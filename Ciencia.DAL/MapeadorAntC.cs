...
namespace Ciencia.DAL
{
    public class MapeadorAntC
    {
        ...
        //        con.Open();
        //        SqlCommand com = new SqlCommand("DELETE FROM Ciencia_Car_AntC", con);
        //        com.ExecuteNonQuery();
        //        return true;
        //    }
        //    catch (Exception ex)
        ...
        //public Boolean MapearAntecedentesC2(BackgroundWorker worker)
        //{
        //    try
        //    {
        //        BorrarTabla();
        ...
        //        var entry = ConfigurationManager.ConnectionStrings["ICBA.Properties.Settings.ConnStr"];
        //        SqlConnection con = new SqlConnection(entry.ConnectionString);
        //        Ciencia_Car_AntCTableAdapter daDest = new Ciencia_Car_AntCTableAdapter();
        //        SqlDataAdapter daOrg = new SqlDataAdapter("select * from Car_AntC_New", con);
        //        DataTable dtOrg = new DataTable();
        //        string queryDes = "select * from ciencia_car_antC";
        ...
        //                                       "where not exists " +
        //                                       "(select * from Car_AntC_New " +
        //                                       "where Car_Ingr_New.Ingr_Id = Car_AntC_New.AntC_Ingr_Id)");
        //        foreach (DataRow filaOrg in dtOrg.Rows)
        //        {
        //            DataRow filaDest = dtDes.NewRow();
        //            filaDest["AntC_Ingr_Id"] = filaOrg["Ingr_Id"];
        //            filaDest["AntC_Pac_Id"] = filaOrg["Ingr_Pac_Id"];
        //            foreach (DataColumn columna in dtDes.Columns.Cast<DataColumn>().Where(columna => columna.ColumnName != "AntC_Ingr_Id" && columna.ColumnName != "AntC_Pac_Id"))
        //            {
