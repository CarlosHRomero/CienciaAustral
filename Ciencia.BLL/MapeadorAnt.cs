...
namespace Ciencia.BLL
{
    public class MapeadorAnt
    {
        ...
        public Boolean MapearAntecedentes2(ProgressBar p)
        {
            DataTable dt;
            ...
            CienciaCarAntTableAdapter daDest = new CienciaCarAntTableAdapter();
            SqlDataAdapter daOrg = new SqlDataAdapter("select * from Car_Ant_New", con);
            DataTable dtOrg = new DataTable();
            ICBA_Cirugia_2003DataSet.CienciaCarAntDataTable dtDes = new ICBA_Cirugia_2003DataSet.CienciaCarAntDataTable();
